...
<?php
$url = "http://localhost/Proyectos/_Website2/backend/models/usuarios.php";
  ...
  <div class="row justify-content-center">
                ...
                echo "
                  <tr>
                    ...
                    <td>
                      ...
                      <a href='http://localhost/Proyectos/_Website2/backend/models/usuarios.php?httpMethods=DELETE&id={$elemento->id}' class='text-decoration-none'>🗑</a>
                    </td>
                  </tr>
                ";
              }
    ...
    <div class="col-md-4 my-2">
      <div class="card">
        ...
        <div class="card-body">
          <form method="POST" action="http://localhost/Proyectos/_Website2/backend/models/usuarios.php">
            <div class="mb-3">
